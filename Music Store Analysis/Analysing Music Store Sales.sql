...
select billing_country, count(*) as numbeer_of_invoices
from invoice
group by billing_country
order by numbeer_of_invoices desc
...
order by total_invoice_value desc limit 1
...
select distinct(customer.customer_id), customer.first_name, customer.last_name, customer.address, track.genre_id, genre.name
from customer
